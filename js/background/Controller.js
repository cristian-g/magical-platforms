            ...
            */
            ...
            for( var i = 0; i < vizkeys.length; i++ ) {
                var li = $( '<li>' + vizkeys[i] + '</li>' );
                    ...
                    li.attr( 'class', 'visualizer liElement' );
                list.append( li );
            }
            ...
            //$( '#defaultsong' ).trigger( 'click' );

            /*$( '#intro-circle' ).css("top", Math.max(0, (($(window).height()) / 2) + $(window).scrollTop()) + "px");
            $( '#intro-circle' ).css("left", Math.max(0, (($(window).width()) / 2) + $(window).scrollLeft()) + "px");*/
        }
    }
